# `crecs_property_fields` — CRECS: Property Fields & Data

Generated from the delivery-1 catalog. Source file: `includes/widgets/template_widgets/class-elementor-crecs-property-fields-widget.php`.

| | |
| --- | --- |
| Relevance | **core** |
| Why | Admin-configured property fields as a label/value card. This is the only "fields" widget that exists. |
