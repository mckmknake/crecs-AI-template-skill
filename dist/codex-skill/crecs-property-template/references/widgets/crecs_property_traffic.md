# `crecs_property_traffic` — CRECS: Property Traffic

Generated from the delivery-1 catalog. Source file: `includes/widgets/template_widgets/class-elementor-crecs-property-traffic-widget.php`.

| | |
| --- | --- |
| Relevance | **core** |
| Why | Traffic-count table. |
| Elementor categories | `cre-cloud-solutions-property-data` |
| Controls contributed by CRECS | 58 |
...
| --- | --- |
| `card_body_typography_font_family` | `table_body_typography_font_family` |
| `card_body_typography_font_size` | `table_body_typography_font_size` |
| `card_body_typography_font_weight` | `table_body_typography_font_weight` |
| `card_body_typography_typography` | `table_body_typography_typography` |
...
| `table_body_text_color` | color | string (hex or rgba) | no | — | `"#000000"` |
